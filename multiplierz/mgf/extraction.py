...
from multiplierz import PY3
from multiplierz.internalAlgorithms import aggregate_points, floatrange
    ...
    def run(self):
        ...
        for time, mz, scanNum, scanLevel, scanMode in self.scanInfo:
            ...
            if scanLevel == 'MS1':
                ...
                continue
            elif self.lastMS1ScanName is None:
                continue
            ...
            # 'and derive_precursor_via not in ['Thermo']', except why would you?
            if (not mzP) or self.derive_precursor_via in ['Direct']:
